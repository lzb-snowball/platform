...
public enum EnumAuthRouteSnowball implements IEnumToDbEnum<AuthRoute> {
    ...
    catalog_snowball(ADMIN, null, CATALOG, "滚雪球管理", null, "el-icon-trophy-1", null, null, null, null, null, 100100, null),
...
//    demo_ALL_AGENT(AGENT, demo, BUTTON, "管理", null, null, "#ALL#demo", null, null, null, null, 100201, null),
    ...
    executeOrderStep(ADMIN, catalog_snowball, MENU, "执行订单步骤", "/snowball/executeOrderStep", null, null, null, null, null, null, 1001100, null),
    ...
    executeOrderStepCommand(ADMIN, catalog_snowball, MENU, "执行订单步骤命令行", "/snowball/executeOrderStepCommand", null, null, null, null, null, null, 1001000, null),
    ...
    executeStep(ADMIN, catalog_snowball, MENU, "执行步骤", "/snowball/executeStep", null, null, null, null, null, null, 1000900, null),
    ...
    executeStepCommand(ADMIN, catalog_snowball, MENU, "执行步骤命令行", "/snowball/executeStepCommand", null, null, null, null, null, null, 1000800, null),
    ...
    executeStepParamRequired(ADMIN, catalog_snowball, MENU, "执行步骤需要的参数", "/snowball/executeStepParamRequired", null, null, null, null, null, null, 1000700, null),
    ...
    executeTemplate(ADMIN, catalog_snowball, MENU, "执行模板的初始配置", "/snowball/executeTemplate", null, null, null, null, null, null, 1000600, null),
    ...
    executeTemplateAndStep(ADMIN, catalog_snowball, MENU, "执行模板和步骤的关联", "/snowball/executeTemplateAndStep", null, null, null, null, null, null, 1000500, null),
    ...
    myExecuteGroup(ADMIN, catalog_snowball, MENU, "我的模板分组", "/snowball/myExecuteGroup", null, null, null, null, null, null, 1000400, null),
    ...
    myExecuteTemplate(ADMIN, catalog_snowball, MENU, "我的执行模板", "/snowball/myExecuteTemplate", null, null, null, null, null, null, 1000300, null),
    ...
    myExecuteTemplateParam(ADMIN, catalog_snowball, MENU, "我的执行模板的参数", "/snowball/myExecuteTemplateParam", null, null, null, null, null, null, 1000200, null),
